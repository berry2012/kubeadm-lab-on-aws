...
Note: Double check Kubernetes version compatibilities with dependencies like containerd, runc etc. before changing the versions.
## Node Details
...
NAME             STATUS   ROLES           AGE   VERSION
k8s-controller   Ready    control-plane   40m   v1.25.4
k8s-worker1      Ready    <none>          39m   v1.25.4
k8s-worker2      Ready    <none>          39m   v1.25.4
